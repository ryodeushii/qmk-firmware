...
[M_LAYER] = LAYOUT_96_ansi(
   QK_REBOOT, DB_TOGG,   IND_TG,    _______,     _______,      _______,   _______,   _______,   _______,   _______,    _______,    _______,   _______,    _______,   _______,     _______,   _______,   _______,   _______,
   ...
   _______,   LGUI_TG,   _______,                              _______,                                                _______,    MO(4),     _______,    SIDE_MOD,  SIDE_VAD,    SIDE_HUI,  _______,   _______)
};

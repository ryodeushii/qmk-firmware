...
// layer Mac
[0] = LAYOUT_ansi_84(
	KC_ESC, 	KC_BRMD,  	KC_BRMU,  	MAC_TASK, 	MAC_SEARCH, MAC_VOICE,  MAC_DND,   	KC_MPRV,  	KC_MPLY,  	KC_MNXT, 	KC_MUTE, 	KC_VOLD, 	KC_VOLU, 	MAC_PRTA, 	KC_F13,    KC_DEL,
...
[1] = LAYOUT_ansi_84(
	...
	_______,				_______,   	_______,   	RGB_TEST,  	_______,   _______ ,   	_______,	MO(4), 		UG_SPDD,	UG_SPDU,	_______,	_______,	            UG_VALU,   _______,
	_______,	_______,	_______,								_______, 								            _______,	MO(1),			            UG_NEXT,   UG_VALD,	UG_HUEU),
// layer win
[2] = LAYOUT_ansi_84(
...
[3] = LAYOUT_ansi_84(
	...
	TOG_CAPS_IND,	SLEEP_TIMEOUT_DEC,   	SLEEP_TIMEOUT_SHOW,   	SLEEP_TIMEOUT_INC,  	_______,   	_______,   	DEBOUNCE_RELEASE_DEC,	DEBOUNCE_RELEASE_SHOW,   	DEBOUNCE_RELEASE_INC,   	_______,  	_______,	_______, 	_______,                            _______,
	_______,				_______,   	_______,   	RGB_TEST,  	_______,   _______ ,   	_______,	MO(4), 		UG_SPDD,	UG_SPDU,	_______,	_______,	            UG_VALU,   _______,
	_______,	_______,	_______,								_______, 								            _______,	MO(3),					UG_NEXT,   UG_VALD,	UG_HUEU),
// layer 4
[4] = LAYOUT_ansi_84(
